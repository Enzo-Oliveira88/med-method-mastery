    ...
    <section id="hero" className="relative min-h-[600px] md:min-h-[700px] flex items-center justify-center overflow-hidden mt-16">
      ...
      <div className="container relative z-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          <h1 className="font-playfair text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-offWhite mb-6 leading-tight uppercase tracking-wide animate-fade-right opacity-0 [animation-delay:200ms]">
            A transformação<br />
            que você<br />
            merece
          </h1>
          ...
          <div className="animate-scale-up opacity-0 [animation-delay:1000ms]">
            <Button 
              ...
              size="lg"
              className="bg-accent hover:bg-accent/90 text-darkerBrown font-crimson text-lg px-10 py-7 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 uppercase font-bold tracking-wide group relative overflow-hidden"
            >
